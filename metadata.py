...
def run(user, append_string):
    ...
    api = tweepy.API(auth)
    user = user.lower()
    output_file = './data/{}_{}.json'.format(user, append_string)
    output_file_short = './data/{}_{}_short.json'.format(user, append_string)
    ...
    zf = zipfile.ZipFile('./data/{}_{}.zip'.format(user, append_string), mode='w')
